...
class Config :
    ...
    def renvoie_config_general(self):
        ...
        nb_ouverture_autorisee=cfg['reward'].getint('nb_ouverture_autorisee')
        sans_punition=cfg['punishment'].getint('without')
            
        return scenario, nom, emplacement_of, autorisation_recompense, probabilite_recompense,sans_punition, nb_ouverture_autorisee
    ...
    def renvoie_config_pittags(self):
        ...
        return facteur_division, portion_de_debut, phase_rfid, duree_par_portion,rfid_actif
